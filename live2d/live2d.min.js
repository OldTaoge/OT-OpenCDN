...
default = o;
	...
	default;
		...
		this.modelSetting.loadModelSetting(i, function() {
			if (/^https?:\/\/|^\/\//i.test(r.modelSetting.getModelFile())) var t = r.modelSetting.getModelFile();
			else var t = r.modelHomeDir + r.modelSetting.getModelFile();
		...
		for (var i = this, e = 0; e < this.modelSetting.getMotionNum(t); e++) {
			if (/^https?:\/\/|^\/\//i.test(this.modelSetting.getMotionFile(t, e))) var r = this.modelSetting.getMotionFile(t, e);
			else var r = this.modelHomeDir + r;
			this.loadMotion(r, r, function(r) {
	...
	default.DEBUG_LOG && console.log("Motion is running."));
		var o, n = this;
		if (/^https?:\/\/|^\/\//i.test(r)) var tmp_r = r;
		else var tmp_r = this.modelHomeDir + r;
		null == this.motions[t] ? this.loadMotion(null, r, function(r) {
